...
if(isset($_POST['search_tutor_btn'])){
   ...
   header("Location: search_tutor.php?search_tutor={$search_tutor}");
   exit();
}
...
<section class="teachers">
   ...
   <form action="" method="post" class="search-tutor">
      <input type="text" name="search_tutor" maxlength="100" placeholder="search coach..." required>
...
if(isset($_GET['tutor_id'])){
   ...
   // Tampilkan informasi lainnya seperti jumlah playlist, jumlah video, jumlah like, jumlah komentar
