         ...
         if (!$user_id) {
            echo '
               <div class="box offer">
                  ...
                  <p>coach billiard ini tidak hanya dipahami sebagai seseorang yang berperan dalam membantu meningkatkan kemampuan atlet. 
                  Pelatih atau coach juga mengacu pada orang yang memiliki peran untuk membantu mereka yang ingin meningkatkan kemampuan di bidang olahraga billard</p>
                  <a href="admin/login.php" class="inline-btn">get started</a>
               </div>
            ';
         }
